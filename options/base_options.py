...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--arch', type=str, default='Clip:ViT-L/14', help='architecture for binary classification')
        ...
        parser.add_argument('--classes', default='', help='classes to train on')
        parser.add_argument('--dataroot', default='./progan_10%', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--name', type=str, default='mff_net', help='name of the experiment. It decides where to store samples and models')
