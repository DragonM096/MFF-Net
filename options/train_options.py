...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--save_latest_freq', type=int, default=25, help='frequency of saving the latest results')
        parser.add_argument('--save_epoch_freq', type=int, default=60, help='frequency of saving checkpoints at the end of epochs')
